#!/bin/bash
#SBATCH --job-name=t5_continued_lr00005_clip1
...
# Logs
#  /netscratch/nrauscher/projects/BA-hydra/logs/slurm_<JOBID>_t5_continued_lr00005_clip1.out
#  /netscratch/nrauscher/projects/BA-hydra/logs/slurm_<JOBID>_t5_continued_lr00005_clip1.err
#
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_lr00005_clip1.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_lr00005_clip1.err

echo "=============================================="
echo "T5 Continued Pretraining - LR 0.00005, Gradient Clip 1.0, Inverse Sqrt"
...
echo "Starting T5 continued pretraining (LR=5e-5 + inverse-sqrt, warmup=60k) ..."
...
srun -K \
    ...
    /bin/bash -c "
        ...
        python src/train.py experiment=t5_continued_pretraining_lr_00005_gradient_clip_1_with_inverse_sqrt_schedule trainer.log_every_n_steps=1
    "
