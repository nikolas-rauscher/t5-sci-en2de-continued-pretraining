#!/bin/bash
#SBATCH --job-name=t5_0olap512_v3_lr001
...
# Logs
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_0olap512_v3_lr001.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_0olap512_v3_lr001.err
...
echo "Experiment: configs/experiment/t5_continued_pretraining_lr_001_bugfixed_text_0olap512_v3_warmup50k.yaml"
...
srun -K \
    ...
    /bin/bash -c "
        ...
        python src/train.py experiment=t5_continued_pretraining_lr_001_bugfixed_text_0olap512_v3_warmup50k trainer.log_every_n_steps=1
    "
