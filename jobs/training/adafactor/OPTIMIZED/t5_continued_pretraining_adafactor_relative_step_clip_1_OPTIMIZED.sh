#!/bin/bash
#SBATCH --job-name=t5_continued_relstep_clip1_OPT-old-data-with-OPTIMIZED-fix
...
# Logs
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_relstep_clip1_OPTIMIZED.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_relstep_clip1_OPTIMIZED.err

echo "=============================================="
echo "T5 Continued Pretraining - OPTIMIZED COLLATOR"
echo "Adafactor relative_step, Clip 1.0"
...
echo "Starting T5 OPTIMIZED continued pretraining (Adafactor relative_step) ..."
echo "Configuration: configs/experiment/t5_continued_pretraining_adafactor_relative_step_clip_1_OPTIMIZED.yaml"
