#!/bin/bash
#SBATCH --job-name=t5_continued_pretraining_lr_001_OPTIMIZED_clean_restart_v2
...
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_pretraining_lr_001_OPTIMIZED_clean_restart_v2.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_continued_pretraining_lr_001_OPTIMIZED_clean_restart_v2.err
...
srun -K \
    ...
    /bin/bash -c "
        ...
        python src/train.py experiment=t5_continued_pretraining_lr_001_OPTIMIZED_clean_restart_v2 trainer.log_every_n_steps=1
    "
