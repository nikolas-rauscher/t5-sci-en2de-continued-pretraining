#!/bin/bash
#SBATCH --job-name=H100_scifive_style_v2
...
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_scifive_style_4gpu_h100_v2.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_scifive_style_4gpu_h100_v2.err
...
srun -K \
    ...
    /bin/bash -c "source .venv_pretraining/bin/activate && python src/train.py experiment=scifive_style_4gpu_h100_v2"
