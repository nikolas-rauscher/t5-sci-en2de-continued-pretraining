#!/bin/bash
#SBATCH --job-name=sliding_windows_tokens
...
#SBATCH --output=logs/slurm-sliding-windows-tokens-%j.out
#SBATCH --error=logs/slurm-sliding-windows-tokens-%j.err

echo "Starting BA-hydra SLIDING WINDOWS TOKENS job at $(date)"
