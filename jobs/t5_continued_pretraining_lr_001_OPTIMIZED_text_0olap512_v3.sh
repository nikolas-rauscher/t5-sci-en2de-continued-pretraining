#!/bin/bash
#SBATCH --job-name=t5_0olap512_v3_lr001_OPT
...
# Logs
#SBATCH --output=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_0olap512_v3_lr001_OPTIMIZED.out
#SBATCH --error=/netscratch/nrauscher/projects/BA-hydra/logs/slurm_%j_t5_0olap512_v3_lr001_OPTIMIZED.err

echo "=============================================="
echo "T5 Continued Pretraining (OPTIMIZED COLLATOR)"
echo "Dataset: text windows (0% overlap, 512 tokens, v3)"
echo "LR: 0.001, Warmup: 50k steps, Gradient Clip: 1.0"
...
echo "Starting T5 continued pretraining (OPTIMIZED - T5 Formula Mode) ..."
echo "Experiment: configs/experiment/t5_continued_pretraining_lr_001_OPTIMIZED_text_0olap512_v3_warmup50k.yaml"
...
srun -K \
    ...
    /bin/bash -c "
        ...
        python src/train.py experiment=t5_continued_pretraining_lr_001_OPTIMIZED_text_0olap512_v3_warmup50k trainer.log_every_n_steps=1
    "
