"""
Optimized DataCollatorForT5MLM from HuggingFace OLM training repo.
...
class DataCollatorForT5MLM:
    ...
    def __call__(self, examples: List[Dict[str, np.ndarray]]) -> Dict[str, np.ndarray]:
        ...
        # Calculate target expanded length for masking
        expanded_length = int(self.input_length * 1.5)  # Allow room for masking
        ...
        # Pad or truncate to target lengths
        ...
        attention_mask = (batch["input_ids"] != self.pad_token_id).astype(np.int32)
