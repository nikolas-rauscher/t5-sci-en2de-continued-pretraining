#!/usr/bin/env python
"""
Wrapper script to run Wechsel transfer with proper imports
"""
...
# Now run the actual transfer script
from cross_lingual_transfer.scripts.wechsel_transfer import main
