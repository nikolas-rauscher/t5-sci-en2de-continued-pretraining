#!/usr/bin/env python
"""
Wrapper script to run ROBUST Wechsel transfer with proper imports
"""
...
# Now run the ROBUST transfer script
from cross_lingual_transfer.scripts.wechsel_transfer_robust import main
